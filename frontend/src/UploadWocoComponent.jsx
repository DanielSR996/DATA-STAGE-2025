...
const UploadWocoComponent = () => {
  ...
  const onDrop = (acceptedFiles) => {
    ...
    axios.post('http://localhost:3000/woco/upload', formData, {
      headers: {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await fetch('http://localhost:3000/woco/upload', {
        method: 'POST',
        body: formData,
      });
...
export default UploadWocoComponent; 